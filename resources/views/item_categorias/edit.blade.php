    ...
    <div class="py-6">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white rounded shadow-sm">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('item-categorias.update', $categoria) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="descripcion" name="descripcion" rows="3"
                                      class="block w-full mt-1 border-gray-300 rounded-md shadow-sm">{{ old('descripcion', $categoria->descripcion) }}</textarea>
