            ...
            <div class="overflow-hidden bg-white rounded shadow-sm">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('unidades.store') }}">
                        ...
                        {{-- Abreviatura (pz, cj, set, etc.) --}}
                        <div class="mb-4">
                            <x-input-label for="abreviatura" value="Abreviatura (ej. pza, cj, set)" />
                            <x-text-input id="abreviatura" name="abreviatura" type="text"
                                          class="block w-full mt-1"
                                          :value="old('abreviatura')" required />
